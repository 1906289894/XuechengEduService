...
public enum MediaCode implements ResultCode {
    ...
    CHUNK_FILE_EXIST_FAIL(true,220010,"分块文件在系统不存在！"),
    MERGE_FILE_FAIL(false,22004,"合并文件失败，文件在系统已存在！"),
    MERGE_FILE_CHECKFAIL(false,22005,"合并文件校验失败！"),
    UPLOAD_FILE_REGISTER_ISNULL(false,22006,"上传块文件为空"),
    CHUNK_FILE_UPLOAD_FAIL(false,22007,"上传块文件失败"),
    MERGE_FILE_CREATEFAIL(false,22008,"合并文件为空");
    //操作代码
